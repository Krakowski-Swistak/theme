...
?>
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
			<div class="blog-title-wrapper bg-[url('<?php the_field('blog_page_title_background',443); ?>')] bg-no-repeat bg-cover bg-right h-[300px] mb-[40px] text-center flex flex-col justify-center items-center">
