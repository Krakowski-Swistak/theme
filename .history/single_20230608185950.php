								...
								<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
									...
									<div class="swiper">
										<div class="swiper-wrapper">
											<div class="swiper-slide bg-slate-200 w-[3450px] h-[250px]">Slide 1</div>
											<div class="swiper-slide bg-slate-200 w-[3450px] h-[250px]">Slide 2</div>
											<div class="swiper-slide bg-slate-200 w-[3450px] h-[250px]">Slide 3</div>
										</div>
