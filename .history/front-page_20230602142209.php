		...
		<main id="main" class="site-main">
			...
			<section id="ks-recommendations" class="ks-recommendations ks-fade">
				<div class="ks-container ks-fadeInBottom">
					...
					<button class="ks-button ks-button--primary">
						<a class="scroll" href="https://www.linkedin.com/in/swistak-krakow/details/recommendations/?detailScreenTabIndex=0" target="_blank"><?php echo esc_html( $hero_button_1_title ); ?></a>
					</button>
				</div>
			</section>
