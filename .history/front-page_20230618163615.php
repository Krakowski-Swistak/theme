		...
		<main id="main" class="site-main">
			...
			<section id="ks-recommendations" class="ks-recommendations ks-fade">
				<div class="ks-container ks-fadeInBottom relative flex flex-col justify-center ">
					...
					<button class="ks-button w-fit desktop:absolute desktop:top-[10px] desktop:right-0">
						<a class="text-black hover:text-[#00b3a7] transition-text ease-out duration-200" href="https://www.linkedin.com/in/swistak-krakow/details/recommendations/?detailScreenTabIndex=0" target="_blank"><?php the_field('recomendation_button_text'); ?> <span class="text-[20px]">	&rarr;</span></a>
					</button>
					<div class="ks-swiper">
			...
			<section id="ks-blog" class="ks-blog ks-fade mb-[135px] pt-[64px] bg-[#f6f6f6]">
				<div class="relative ks-container ks-fadeInBottom">
					...
					<button class="ks-button ks-button--primary inverted mt-[20px] mb-[50px] absolute top-[65px] right-0">
							<a href="https://swistak.webo.design/blog/"><span class="text-[20px]"> &rarr;</span> Wszystkie posty</a>
						</button>
					<div class="blog-wrapper mb-[60px] flex justify-between gap-[30px]">
						...
						?>
							<div class="post-wrapper relative mb-[30px] w-1/2">
								<div class="post-img h-[300px] rounded-[10px] mb-[35px] overflow-hidden bg-[url('<?php echo $postImageUrl[0]; ?>')] bg-center bg-cover bg-no-repeat">
								</div>
