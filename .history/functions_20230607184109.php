...
// add_filter('previous_posts_link_attributes', 'add_custom_classes_to_post_navigation');
...
function posts_link_next_class($format){
	$format = str_replace('href=', 'class="next ks-button ks-button--primary p-[16px_26px]" href=', $format);
	return $format;
}
add_filter('next_post_link', 'posts_link_next_class');

function posts_link_prev_class($format) {
	$format = str_replace('href=', 'class="prev ks-button ks-button--primary p-[16px_26px]" href=', $format);
	return $format;
}
