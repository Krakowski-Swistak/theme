					...
					<div class="blog-wrapper mb-[60px] flex justify-between gap-[30px]">
						...
						?>
							<div class="post-wrapper relative mb-[30px] w-1/2">
								<div class="post-img h-[395px] rounded-[10px] mb-[35px] overflow-hidden bg-[url('<?php echo $postImageUrl[0]; ?>')] bg-center bg-cover bg-no-repeat">
								</div>
								...
								<a href="<?php the_permalink(); ?>" class="absolute bottom-0 left-0 text-black hover:text-[#00b3a7] transition ease-out duration-200">Czytaj więcej >></a>
							</div>
						<?php };
							wp_reset_postdata(); 
						?>
