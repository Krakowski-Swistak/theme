								...
								<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
									...
									<div class="ks-swiper ks-swiper--shadow">
										...
										<div class="swiper-wrapper">
											<div class="swiper-slide bg-slate-200 max-w-[450px] max-h-[400px]">Slide 1</div>
											<div class="swiper-slide bg-slate-200 max-w-[450px] max-h-[400px]">Slide 2</div>
											<div class="swiper-slide bg-slate-200 max-w-[450px] max-h-[400px]">Slide 3</div>
										</div>
