...
?>
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
			<div class="blog-title-wrapper bg-[url('<?php the_sub_field('blog_page_title_background'); ?>')] h-[250px] mb-[40px] text-center flex justify-center items-center">
				<?php the_sub_field('blog_page_title_text'); ?>
			</div>
