...
<aside id="secondary" class="widget-area">
	...
	<div class="contact-wrapper">
		...
		<div class="ks-contact-label ks-contact-label--phone before:w-[34px]">
			<a href="<?php echo esc_url( $footer_phone_url ); ?>" target="<?php echo esc_attr( $footer_phone_target ); ?>" class="text-[15px] font-normal"><?php echo esc_html( $footer_phone_title ); ?></a>
		</div>
