			...
			<section id="ks-recommendations" class="ks-recommendations ks-fade">
				<div class="ks-container ks-fadeInBottom relative flex flex-col justify-center ">
					...
					<button class="ks-button w-fit desktop:absolute desktop:top-[10px] desktop:right-0">
						<a class="text-black hover:text-[#00b3a7]" href="https://www.linkedin.com/in/swistak-krakow/details/recommendations/?detailScreenTabIndex=0" target="_blank"><?php the_field('recomendation_button_text'); ?> <span class="text-[20px]">	&rarr;</span></a>
					</button>
					<div class="ks-swiper">
