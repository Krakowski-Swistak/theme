				...
				<div class="page-content-container mb-[40px] desktop:flex desktop:justify-between desktop:gap-[80px]">
					<div class="page-post-content-container basis-[70%]">
						...
						<div class="post-cta mb-[25px] bg-[#F4F4F4] p-[30px_60px]">
							...
							<a href="<?php echo esc_url( $footer_email_url ); ?>" target="<?php echo esc_attr( $footer_email_target ); ?>" class="text-[20px] text-black font-medium"><?php echo esc_html( $footer_email_title ); ?></a>
