							...
							?>
									<div class="relativev post-wrapper group mb-[30px] flex gap-[30px] justify-between overflow-hidden">
										...
										<div class="post-text-wrapper relative basis-2/3 pr-[50px]">
											...
											<p class="mb-0 text-[15px] leading-[22px]"><?php echo wp_trim_words(get_the_excerpt(), 16); ?></p>
											<a href="<?php the_permalink(); ?>" class="text-black hover:text-[#00b3a7] transition ease-out duration-200 absolute bottom-[10px] right-[50px]">Czytaj więcej <span class="text-[20px]">&rarr;</span></a>
										</div>
									</div>
								<?php	
								endwhile;
