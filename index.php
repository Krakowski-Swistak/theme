			...
			<div class="ks-container">
				...
				<div class="page-content-container desktop:flex justify-between gap-[80px]">
					<div class="posts-wrapper mb-[30px] desktop:basis-[70%] basis-[100%]">
							...
							?>
									<div class="relativev post-wrapper group desktop:mb-[40px] mb-[70px] flex desktop:flex-row flex-col desktop:gap-[30px] gap-[10px] justify-between overflow-hidden">
										<?php
											if ($postImageUrl){
											?>
