							...
							?>
									<div class="relativev post-wrapper group mb-[30px] flex desktop:flex-row flex-col desktop:gap-[30px] gap-[10px] justify-between overflow-hidden">
										...
										<div class="post-text-wrapper relative basis-2/3 desktop:pr-[50px] pr-0">
											...
											<a href="<?php the_permalink(); ?>" class="text-black hover:text-[#00b3a7] text-[16px] font-medium transition ease-out duration-200 absolute bottom-[10px] desktop:right-[50px] left-[20px]">Czytaj więcej <span class="text-[20px]">&rarr;</span></a>
										</div>
									</div>
								<?php	
								endwhile;
